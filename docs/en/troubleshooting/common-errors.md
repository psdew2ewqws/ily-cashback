...
3. **Firewall blocking app**
   ...
   * Allow ILY\_Cash.exe through firewall
4. **Restart the app**
...
> خطأ في العملية قيمة الفاتورة يجب أن تكون 2.00 دينار على الأقل
...
> Old Receipt - Cannot Be Redeemed **FRAUD ATTEMPT DETECTED**
...
> **SECURITY ALERT** Suspicious activity detected Enter security PIN to continue
...
**3. Verify Message Format** From backend, messages must include phone in correct format
...
**5. Monitor Console Logs** Run app from command line to see WebSocket activity:
...
**2. Verify Timer is Running** Check console for:
...
**3. Check GitHub Access** Update URL: `https://raw.githubusercontent.com/psdew2ewqws/ily-cashback/main/appcast.xml`
...
**2. Check Error Logs** Run app from command prompt to see crash logs:
...
**GitHub Issues** (for technical bugs): https://github.com/psdew2ewqws/ily-cashback/issues
